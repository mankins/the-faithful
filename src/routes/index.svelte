...
<main>
		...
		<div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24">
		  <div>
			...
			<div class="mt-20">
			  ...
			  <div class="mt-6 sm:max-w-xl">
				...
				<p>
					The discovery of the image of Pope John Paul II on a lollipop for sale at the Vatican inspires a twenty-year voyage deep into the worlds of Elvis Presley, Pope John Paul II, and Princess Diana in this meditation on fans, faith, and image.
				</p>
			  </div>
			  <form action="#" class="mt-12 sm:max-w-lg sm:w-full sm:flex">
				...
				<div class="mt-4 sm:mt-0 sm:ml-3">
				  <button type="submit" class="block w-full rounded-md border border-transparent px-5 py-3 bg-gray-800 text-base font-medium text-white shadow hover:bg-rose-900 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:px-10">Notify me</button>
				</div>
			  </form>
			</div>
		  </div>
		  ...
		  <div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
			<div class="hidden sm:block">
			  <div class="absolute inset-y-0 left-1/2 w-screen bg-gray-50 rounded-l-3xl lg:left-40 lg:right-0 lg:w-full"></div>
			  <svg class="absolute top-8 right-1/2 -mr-3 lg:m-0 lg:left-0" width="404" height="392" fill="none" viewBox="0 0 404 392">
				<defs>
				  <pattern id="837c3e70-6c3a-44e6-8854-cc48c737b659" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
					<rect x="0" y="0" width="4" height="4" class="text-gray-200" fill="none" />
				  </pattern>
				</defs>
				<rect width="404" height="392" fill="url(#837c3e70-6c3a-44e6-8854-cc48c737b659)" />
			  </svg>
			</div>
			<div transition:fade="{{delay:10}}" class="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
			  <img class="w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none"  src="/a-movie.png" alt="The Faithful: A film on fans and followings by Annie Berman">
			</div>
		  </div>
		</div>
	  ...
	  <div class="relative mt-2 md:mt-20">
		<div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
		  <div class="relative sm:py-16 lg:py-0">
			...
			<div class="relative mx-auto max-w-md px-3 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
				<Visibility steps={100} let:percent let:unobserve let:intersectionObserverSupport>
					{#if percent > 50}
					<div use:unobserve transition:fade="{{delay:10}}" class="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
				<img class="absolute inset-0 h-full w-full object-cover" src="/annie-jerry-the-faithful.jpg" alt=""/>
				<div class="absolute inset-0 bg-rose-100" style="mix-blend-mode: multiply;"></div>
				<div class="relative px-8">
				  <blockquote class="mt-8">
					<div class="relative text-lg font-medium text-white md:flex-grow">
					  <svg class="absolute top-0 left-0 transform -translate-x-3 -translate-y-2 h-8 w-8 text-gray-500" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
					...
					<footer class="mt-4">
					  <p class="text-base font-semibold text-rose-200">Matt Mankins, Producer</p>
					</footer>
				  </blockquote>
				</div>
			  </div>
	  ...
	  <div class="mt-32">
		<div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
		  <div class="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
			...
			<div class="mt-12 grid grid-cols-3 gap-6 md:grid-cols-3 lg:mt-0 lg:grid-cols-3">
			  <div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50 rounded-2xl">
				<img class="max-h-16" src="/elvis-circle.min.svg" alt="Elvis Presley">  
			</div>
			  <div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50 rounded-2xl">
				<img class="max-h-16" src="/pope-john-paul.min.svg" alt="Pope John Paul II">
			</div>
			  <div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50 rounded-2xl">
				<img class="max-h-16" src="/diana-princess-of-wales.min.svg" alt="Diana Princess of Wales">
			</div>
			</div>
		  </div>
		</div>
		...
		<div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
		  <div class="relative sm:py-16 lg:py-0">
			...
			<div class="relative mx-auto max-w-md px-3 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
				<Visibility steps={100} let:percent let:unobserve let:intersectionObserverSupport>
					{#if percent > 50}
					<div use:unobserve transition:fade="{{delay:10}}" class="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
				<img class="absolute inset-0 h-full w-full object-cover" src="/annie-berman.png" alt="Annie Berman"/>
				<div class="absolute inset-0 bg-rose-100" style="mix-blend-mode: multiply;"></div>
				<div class="relative px-8">
				  <blockquote class="mt-8">
					<footer class="mt-4 pt-20">
					  <p class="text-base font-semibold text-rose-200">Annie Berman, Filmmaker</p>
					</footer>
				  </blockquote>
				</div>
			  </div>
		  ...
		  <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
			...
			<div class="pt-12 sm:pt-16 lg:pt-20">
			  ...
			  <div class="mt-6 text-gray-500 space-y-6">
				  <h2 class="text-2xl text-gray-900 font-extrabold tracking-tight sm:text-3xl">Annie Berman</h2>
				<p class="text-lg">
	  ...
	  <div class="relative mt-24 sm:mt-32 sm:py-16">
		...
		<div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
		  <div class="relative rounded-2xl px-6 py-10 bg-gray-500 overflow-hidden shadow-xl sm:px-12 sm:py-20">
