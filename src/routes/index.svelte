          ...
          <div>
            ...
            <div class="mt-4 sm:mt-20">
              ...
              <div class="mt-6 sm:max-w-xl">
                ...
                >The King, The Pope, The Princess</h1>
              ...
              <form method="POST" action="https://docs.google.com/forms/u/0/d/e/1FAIpQLScKO79aNMhPsZq2LB1EPDA8RyygBu2T0bod4seu89XKtNdAbw/formResponse" class="mt-12 sm:max-w-lg sm:w-full sm:flex">
        ...
        >
          <div class="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
            <div>
              ...
              <p class="mt-6 max-w-3xl text-lg leading-7 text-gray-500">
				We're honored to have our distribution sponsored by <a href="https://www.grantfortheweb.org/" class="underline text-rose-500" target="_blank">Grant for the Web</a>. Grant for the Web is a $100M fund to boost open, fair, and inclusive standards and innovation in Web Monetization.
			  </p>
          ...
          >
            ...
            <div class="relative">
              <div class="sm:text-center">
                ...
                >Attend our world premiere event</h2>
                <p class="mt-6 mx-auto max-w-2xl text-lg text-rose-100">
					We'll notify you when our tickets come on sale with all the details about our virtual cinema release.
                </p>
              </div>
        ...
        >
          ...
          <div class="px-5 py-2">
            <a
              ...
              target="_blank"
              class="text-base text-gray-400 hover:text-gray-300"> Contact </a>
          </div>
        </nav>
