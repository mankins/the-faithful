<footer class="pt-24 bg-gray-900 sm:pt-12">
  <div
  ...
  >
    ...
    <div class="mt-8 flex justify-center space-x-6">
      ...
      <a
        href="https://medium.com/the-faithful-the-king-the-pope-the-princess"
        class="text-gray-400 hover:text-gray-300"
        title="Medium - Blog"
        target="_blank"
      >
        <span class="sr-only">Medium</span>
        <svg class="h-12 w-12" fill="currentColor" viewBox="0 0 1043.63 592.71"
          ><g data-name="Layer 2"
            ><g data-name="Layer 1"
              ><path
