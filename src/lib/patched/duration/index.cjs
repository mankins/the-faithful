...
var d           = require("d")
  ...
  , daysInMonth = require("es5-ext/date/hash/days-in-month")
  , copy        = require("es5-ext/date/hash/copy")
  , dfloor      = require("es5-ext/date/hash/floor-day")
  , mfloor      = require("es5-ext/date/hash/floor-month")
  , yfloor      = require("es5-ext/date/hash/floor-year")
